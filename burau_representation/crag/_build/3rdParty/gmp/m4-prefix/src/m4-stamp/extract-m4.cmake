...
#
get_filename_component(filename "/Users/borisgolikov/Desktop/Burau/scripts/crag/_build/3rdParty/gmp/m4-prefix/src/m4-1.4.19.tar.bz2" ABSOLUTE)
get_filename_component(directory "/Users/borisgolikov/Desktop/Burau/scripts/crag/_build/3rdParty/gmp/m4-prefix/src/m4" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-m4${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-m4${i}")
