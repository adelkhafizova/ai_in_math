...
class LaurentPolynomial:
    ...
    def __mul__(self, other):
        ...
        # For large polynomials, consider using FFT-based convolution
        # NumPy's convolve uses FFT internally for large arrays
        new_min_power = int(self.min_power + other_converted.min_power)
        
        # Pre-estimate result size to avoid reallocation
