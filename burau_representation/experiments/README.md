...
```python
"""
generate all words of length n (picked between 10 and 15) and all matrices
that correspond to them (where field over which matrices are taken is also specified),
it stores them as dictionary with keys being words in "A,B,a,b"
and values objects of type LaurentMatrix.
"""
